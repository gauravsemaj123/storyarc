...
@onready var inv_container: GridContainer = $"."


@onready var item = preload("res://inventorymain/Slot.tscn")
var invSize = 25
...
func _ready():
	...
	#Set their H and V Constants
	inv_container.add_theme_constant_override("HSeparation", -1)
